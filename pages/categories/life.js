  ...
  return (
    <div>
      <Layout active="life">
        ...
        {/* Page hero card */}
        <div className="ui-card p-6 mt-6 mb-8 bg-gradient-to-r from-violet-500/5 to-blue-500/5 border-violet-500/20">
          <div className="flex items-center gap-3 mb-2">
            <span className="w-1 h-7 rounded-full bg-gradient-to-b from-violet-500 to-blue-500 flex-shrink-0" />
            <h1 className="text-2xl font-bold font-mon">Life Stories</h1>
          </div>
          <p className="text-muted text-sm ml-4">
            Personal experiences, reflections, and lessons learned along the
            journey of life.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-x-8 lg:grid-cols-1 lg:gap-x-0">
          <div className="col-span-2 lg:col-span-1 lg:order-2 mt-6">
            {hasError ? (
              <ErrorState description="We could not load life stories." />
            ) : posts.length === 0 ? (
              <EmptyState
                title="No life stories found"
